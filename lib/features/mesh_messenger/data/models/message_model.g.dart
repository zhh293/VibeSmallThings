...
void _messageModelSerialize(
  ...
  writer.writeBool(offsets[1], object.isEncrypted);
...
MessageModel _messageModelDeserialize(
  ...
  object.id = id;
  object.isEncrypted = reader.readBool(offsets[1]);
  ...
  object.status =
      _MessageModelstatusValueEnumMap[reader.readStringOrNull(offsets[5])] ??
          MessageStatus.sending;
  object.timestamp = reader.readDateTime(offsets[6]);
  object.type =
      _MessageModeltypeValueEnumMap[reader.readStringOrNull(offsets[7])] ??
          MessageType.text;
  return object;
}
...
P _messageModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 4:
      return (reader.readString(offset)) as P;
    case 5:
      return (_MessageModelstatusValueEnumMap[
...
extension MessageModelQuerySortBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> sortByIsEncrypted() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQuerySortThenBy
  ...
  QueryBuilder<MessageModel, MessageModel, QAfterSortBy> thenByIsEncrypted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEncrypted', Sort.asc);
    });
  }
...
extension MessageModelQueryWhereDistinct
  ...
  QueryBuilder<MessageModel, MessageModel, QDistinct> distinctByIsEncrypted() {
    return QueryBuilder.apply(this, (query) {
...
extension MessageModelQueryProperty
  ...
  QueryBuilder<MessageModel, bool, QQueryOperations> isEncryptedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageStatus, QQueryOperations> statusProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MessageModel, MessageType, QQueryOperations> typeProperty() {
    return QueryBuilder.apply(this, (query) {
